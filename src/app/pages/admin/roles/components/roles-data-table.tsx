        ...
        <div className="flex flex-col ">
            <div className='flex justify-between items-center'>
                <div className="flex flex-rwo gap-2 items-center px-3">
                    <p className="font-medium">Role list</p>
                    <p className="dark:bg-gray-800 px-2 rounded-md bg-gray-100 text-gray-600 text-[13px]">{totalRoles} roles</p>
                </div>
                <div className="flex gap-3 items-center p-3 border-b border-b-[1px] border-b-secondary">
                    ...
                    <Input
                        ...
                        className="max-w-sm"
                    />
                    <Button onClick={() => fetchRoles()} variant='outline' className='p-1 gap-2'><IconRefresh size={18} />Refresh</Button>
                    <NewRoleDialog />
                </div>
            </div>
            <div className="">
