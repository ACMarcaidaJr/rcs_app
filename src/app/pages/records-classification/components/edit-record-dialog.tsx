...
import { IconDeviceFloppy, IconEditCircle, IconAlertCircle } from "@tabler/icons-react"
...
const UTILITY_OPTIONS = ["Administrative", "Legal", "Fiscal", "Historical"];
...
export function EditSeriesItemDialog({ item, onSuccess }: EditSeriesItemDialogProps) {
    ...
    React.useEffect(() => {
        if (item && open) {
            form.reset({
                ...
                retention_period_active: item.retention_period_active ?? '',
                retention_period_storage: item.retention_period_storage ?? '',
                retention_period_total: item.retention_period_total ?? '',
    ...
    React.useEffect(() => {
        if (watchTimeValue === "P") {
            form.setValue("retention_period_active", "")
            form.setValue("retention_period_storage", "")
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>Modify record properties for RA 9470 compliance.</DialogDescription>
                </DialogHeader>
