...
export async function POST(req: NextRequest) {
    try {
        ...
        const { rcs_records_seriesid, utility_value, is_nap_grds, office_guid, ...req_body } = await req.json();
        const payload: any = {
            ...req_body,
        ...
        payload["office_id@odata.bind"] = `/${process.env.OFFICE_TABLE}(${office_guid})`;
