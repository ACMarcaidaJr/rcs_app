            ...
            <div className="flex flex-col gap-4">
                ...
                <Alert className="bg-blue-50/40 dark:bg-blue-950/20 border-blue-100 dark:border-blue-900/50 shadow-sm">
                    ...
                    <AlertDescription className="text-slate-600 dark:text-slate-400 text-xs leading-relaxed">
                        <strong className="text-blue-800 dark:text-blue-300">Inventory Instruction:</strong> Each row below represents a category from your
                        <strong className="text-slate-900 dark:text-slate-100 font-bold underline decoration-slate-200 dark:decoration-slate-800 underline-offset-2 ml-1">
                            Records Series Title and Description
                        </strong>.
                        Use this section to list specific record types and provide the required details like dates and volume.
                        <span className="block mt-1 font-medium text-slate-500 italic">
                            Note: Changes made here only apply to this form and will not change the original inventory data.
                        </span>
                    </AlertDescription>
                </Alert>
            </div>
