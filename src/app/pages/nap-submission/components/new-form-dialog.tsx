    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-5xl w-full max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className='flex flex-row gap-3 items-center'>
            <span>Creating NAP Form No. 1.</span>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className='flex flex-col gap-3'>
            <div className="flex flex-col gap-2 p-3 border rounded-lg border-secondary rounded-lg">
              <div className="flex items-center gap-2 text-muted-foreground italic">
                ...
                <span>Provide a name to easily identify this form later.</span>
              </div>
              <div className="grid gap-4 p-3  grid-cols-1 ">
                <FormField
            ...
            <div className="flex flex-col gap-2 p-3 border rounded-lg border-secondary rounded-lg">
              <div className="flex items-center gap-2 text-muted-foreground italic">
                <IconExclamationCircle size={16} className="" />
                <span>Section Header: NAP Form No. 1</span>
              </div>
              <div className="grid gap-4 p-3  grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
                <FormField
                  control={form.control}
                  name="name_of_office"
                  render={({ field }) => (
            ...
            <div className="flex flex-col gap-2 p-3 border rounded-lg border-secondary">
              <div className="flex items-center gap-2 text-muted-foreground italic">
                ...
                <span>Additional information can be entered below at a later stage.</span>
              </div>

              <div className="grid gap-4 p-3 grid-cols-1 md:grid-cols-2">
                <FormField
                  control={form.control}
                  name="assistance_name"
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Assisting Name</FormLabel>
                      <FormControl>
                        <Input placeholder="Enter name" {...field} />
                      </FormControl>
                      <FormMessage />
                ...
                <FormField
                  control={form.control}
                  name="assistance_position"
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Assisting Position Title</FormLabel>
                      <FormControl>
              ...
              <div className="grid gap-4 p-3 grid-cols-1 md:grid-cols-2">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Approver Position Title</FormLabel>
                      <FormControl>
                        <Input placeholder="Enter position title" {...field} />
                      </FormControl>
                      <FormMessage />
